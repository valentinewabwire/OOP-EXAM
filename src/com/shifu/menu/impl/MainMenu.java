...
public class MainMenu implements Menu {
	...
	/**
	 * The start() function is an infinite loop that displays a menu, takes user input, and navigates to
	 * the corresponding menu based on the input.
	 */
	@Override
	public void start() {
			while (true){
...
/**
 * The function prints the main menu header, including different text depending on whether a user is
 * logged in or not.
 */
	@Override
